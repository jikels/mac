...
rm -rf /opt/homebrew/Caskroom/miniconda3/envs/mac/lib/python3.9/site-packages/mujoco_py
rm -rf /opt/homebrew/Caskroom/miniconda3/envs/mac/lib/python3.9/site-packages/mujoco_py-2.1.2.14.dist-info

# which python
# exit

export CC=/opt/homebrew/bin/gcc-11         # see https://github.com/openai/mujoco-py/issues/605
pip install mujoco-py==2.1.2.14 && python -c 'import mujoco_py'